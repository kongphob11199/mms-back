...
type AuthServiceClient interface {
	...
	CheckAuth(ctx context.Context, in *EmptyAuth, opts ...grpc.CallOption) (*StatusResponse, error)
}
...
func (c *authServiceClient) CheckAuth(ctx context.Context, in *EmptyAuth, opts ...grpc.CallOption) (*StatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AuthServiceServer interface {
	...
	CheckAuth(context.Context, *EmptyAuth) (*StatusResponse, error)
...
func (UnimplementedAuthServiceServer) CheckAuth(context.Context, *EmptyAuth) (*StatusResponse, error) {
